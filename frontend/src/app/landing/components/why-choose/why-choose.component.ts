  ...
  reasons = [
    {
      ...
      description: 'Stop switching between apps. NexConnect brings HR, CRM, and ERP together.',
    ...
    },
    {
      ...
      description: 'Bank-grade encryption and role-based access control (RBAC) keep your data safe.',
      icon: 'M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z'
    },
    {
      title: 'AI-Driven Insights',
      description: 'Leverage our built-in AI analytics to predict sales trends, identifying churn risks, and optimize your workforce planning automatically.',
    ...
    },
    {
      ...
      description: 'Built on a microservices architecture that grows with you. From 10 employees to 10,000, NexConnect handles the load without missing a beat.',
